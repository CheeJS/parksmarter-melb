...
const AboutUs = () => {
  ...
  return (
    <PageContainer>
      ...
      <Section>
        <SectionTitle>About Krusty Peak</SectionTitle>
        <CardContent style={{ marginBottom: '2rem', fontSize: '1.1rem' }}>
          Krusty Peak is a dynamic team of innovators dedicated to creating smart solutions for urban challenges.
